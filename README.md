...
metadata file in yaml format to describe the project e. g. B_cinera.yaml, Can be downloaded from [HERE](https://drive.google.com/file/d/1ojKTtdYzZEfYra9FuCwSsGSos7JLvgcj/view?usp=sharing).
